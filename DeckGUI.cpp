...
const char * image_names[] = {   	
	// Set up ACE of {CLUB,DIAMOND,HEART,SPADE}
	...
	// Set up TEN of {CLUB,DIAMOND,HEART,SPADE}
	"img/0_9.png", "img/1_9.png", "img/2_9.png", "img/3_9.png",

	// Set up JACK of {CLUB,DIAMOND,HEART,SPADE}
	"img/0_j.png", "img/1_j.png", "img/2_j.png", "img/3_j.png",

	// Set up QUEEN of {CLUB,DIAMOND,HEART,SPADE}
	"img/0_q.png", "img/1_q.png", "img/2_q.png", "img/3_q.png",

	// Set up KING of {CLUB,DIAMOND,HEART,SPADE}
...
Glib::RefPtr<Gdk::Pixbuf> DeckGUI::image(const Card &c) {
